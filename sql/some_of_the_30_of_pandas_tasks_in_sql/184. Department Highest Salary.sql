...
SELECT _Department.name AS 'Department',
_Employee.name AS 'Employee',
_Employee.salary AS Salary
...
RIGHT JOIN (
    SELECT max(_Employee1.salary) AS _salary,
    _Employee1.departmentId AS _Employee_Department 
